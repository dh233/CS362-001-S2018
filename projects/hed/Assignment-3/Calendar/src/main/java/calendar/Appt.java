...
public class Appt{
	...
	public void setValid() {
		...
		if (startMonth < 1 || startMonth > 12)
			...
			this.valid = false;
		else if (startYear <= 0) //corrected to less than or equal to 0
			this.valid = false;
		else {
    ...
    public String getTitle() {
        return title;//fixed from description
    }
    ...
    private String represntationApp(){
        String half = (getStartHour() > 11) ? "pm" : "am";//fixed from swapped am and pm
