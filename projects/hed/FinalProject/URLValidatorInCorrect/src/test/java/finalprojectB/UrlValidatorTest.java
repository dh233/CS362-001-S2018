...
public class UrlValidatorTest extends TestCase {
   ...
   public void SchemePartitionTest() //schemepartitiontest
   {
		String[] schemes = {"HTTP", "http", "https"}; 
		
		UrlValidator urlDefault = new UrlValidator();
		String d_name = "google.com/";
		System.out.println(urlDefault.isValid(null +d_name));
		System.out.println(urlDefault.isValid("http://////////"+d_name));
		System.out.println(urlDefault.isValid("ftp://"+d_name));
		System.out.println(urlDefault.isValid("http://" +d_name));
		System.out.println(urlDefault.isValid("fjasdk://" +d_name));
		System.out.println(urlDefault.isValid(d_name));
		System.out.println(urlDefault.isValid("http:"+d_name));
		System.out.println(urlDefault.isValid("http:/"+d_name));
		System.out.println(urlDefault.isValid("https:///"+d_name));
		
		UrlValidator urlScheme = new UrlValidator(null, null, UrlValidator.ALLOW_ALL_SCHEMES);   //test the constructor with ALLOW_ALL_SCHEMES flag on
		System.out.println(urlScheme.isValid(null +d_name));
		//System.out.println(urlScheme.isValid("https://"+d_name));
		//System.out.println(urlScheme.isValid("ftp://"+d_name));
		System.out.println(urlScheme.isValid("http://" +d_name));
		//System.out.println(urlScheme.isValid("fjasdk://" +d_name));
		//System.out.println(urlScheme.isValid(d_name));
		System.out.println(urlScheme.isValid("http:"+d_name));
		System.out.println(urlScheme.isValid("http:/"+d_name));
		
		//testing urls with allow_2_slashes and allow all schemes flags on.
		UrlValidator urlScheme2 = new UrlValidator(schemes, UrlValidator.ALLOW_2_SLASHES+UrlValidator.ALLOW_ALL_SCHEMES);
		System.out.println(urlScheme2.isValid(null +d_name));
		//System.out.println(urlScheme2.isValid("https://"+d_name));
		//System.out.println(urlScheme2.isValid("ftp://"+d_name));
		System.out.println(urlScheme2.isValid("http://" +d_name));
		//System.out.println(urlScheme2.isValid("fjasdk://" +d_name));
		//System.out.println(urlScheme2.isValid(d_name));
		System.out.println(urlScheme2.isValid("http:"+d_name));
		System.out.println(urlScheme2.isValid("http:/"+d_name));
   }

   public void DomainPartitionTest() //domainpartitiontest
   {
		String[] schemes = {"HTTP", "http", "https"}; 
		String s_name = "http://";
		UrlValidator urlDefault = new UrlValidator();
		UrlValidator urlScheme = new UrlValidator(null, null, UrlValidator.ALLOW_ALL_SCHEMES);   //test the constructor with ALLOW_ALL_SCHEMES flag on
		UrlValidator urlScheme2 = new UrlValidator(schemes, UrlValidator.ALLOW_2_SLASHES+UrlValidator.ALLOW_ALL_SCHEMES);
		System.out.println(urlDefault.isValid(s_name + null));
		System.out.println(urlScheme.isValid(s_name + null));
		System.out.println(urlScheme2.isValid(s_name + null));
		System.out.println(urlDefault.isValid(s_name + "google.com/"));
		System.out.println(urlScheme.isValid(s_name + "google.com/"));
		System.out.println(urlScheme2.isValid(s_name + "google.com/"));
		System.out.println(urlDefault.isValid(s_name + "robot.com/"));
		System.out.println(urlScheme.isValid(s_name + "robot.com/"));
		System.out.println(urlScheme2.isValid(s_name + "robot.com/"));
		System.out.println(urlDefault.isValid(s_name + "1231.com/"));
		System.out.println(urlScheme.isValid(s_name + "1231.com/"));
		System.out.println(urlScheme2.isValid(s_name + "1231.com/"));
		System.out.println(urlDefault.isValid(s_name + "1231/"));
		System.out.println(urlScheme.isValid(s_name + "1231/"));
		System.out.println(urlScheme2.isValid(s_name + "1231/"));
		System.out.println(urlDefault.isValid(s_name));
		System.out.println(urlScheme.isValid(s_name));
		System.out.println(urlScheme2.isValid(s_name));
		System.out.println(urlDefault.isValid(s_name + ".com/"));
		System.out.println(urlScheme.isValid(s_name + ".com/"));
		System.out.println(urlScheme2.isValid(s_name + ".com/"));
		
   }

   public void PathPartitionTest()//pathpartitiontest
   { 
		String[] schemes = {"HTTP", "http", "https"}; 
		String a_name = "http://google.com";
		UrlValidator urlDefault = new UrlValidator();
		UrlValidator urlScheme = new UrlValidator(null, null, UrlValidator.ALLOW_ALL_SCHEMES);   //test the constructor with ALLOW_ALL_SCHEMES flag on
		UrlValidator urlScheme2 = new UrlValidator(schemes, UrlValidator.ALLOW_2_SLASHES+UrlValidator.ALLOW_ALL_SCHEMES);
		System.out.println(urlDefault.isValid(a_name + null));
		System.out.println(urlScheme.isValid(a_name + null));
		System.out.println(urlScheme2.isValid(a_name + null));
		System.out.println(urlDefault.isValid(a_name + "/faqs/ds.html"));
		System.out.println(urlScheme.isValid(a_name + "/faqs/ds.html"));
		System.out.println(urlScheme2.isValid(a_name + "/faqs/ds.html"));
		System.out.println(urlDefault.isValid(a_name + "/faqs"));
		System.out.println(urlScheme.isValid(a_name + "/faqs"));
		System.out.println(urlScheme2.isValid(a_name + "/faqs"));
		System.out.println(urlDefault.isValid(a_name + "/***"));
		System.out.println(urlScheme.isValid(a_name + "/***"));
		System.out.println(urlScheme2.isValid(a_name + "/***"));
		System.out.println(urlDefault.isValid(a_name));
		System.out.println(urlScheme.isValid(a_name));
		System.out.println(urlScheme2.isValid(a_name));
		System.out.println(urlDefault.isValid(a_name + " 2139012 / 1239210312 21321/ 10019231/"));
		System.out.println(urlScheme.isValid(a_name + " 2139012 / 1239210312 21321/ 10019231/"));
		System.out.println(urlScheme2.isValid(a_name + " 2139012 / 1239210312 21321/ 10019231/"));
  ...
  public void testYourFirstPartition()
   ...
   public void testIsValid()
   {
		...
		String schemel = "http"; //used only for fixing crashing
	...
	//			System.out.println(" Seed:"+randomseed );
				...
				for (int i = 0; i < NUM_TESTS; i++) 
				{
					...
					String input2; //used to correct crashing
					...
					if (r_input_type == 1)   //construct url string
						input2 = schemel + connection_semi[r_semi] + connection_slash[r_slash] + connection_semi[r_slash] + return_random_string() + end[r_end] + connection_slash[r_slash];
					else if (r_input_type == 2)
						input2 = schemel + connection_semi[r_semi] + connection_slash[r_slash] + connection_semi[r_slash] + return_random_symbol_string() + end[r_end] + connection_slash[r_slash];
					else if (r_input_type == 3)
						input2 = schemel + connection_semi[r_semi] + connection_slash[r_slash] + connection_semi[r_slash] + return_random_symbol_string() + end[r_end] + connection_slash[r_slash] + return_random_string();
					else 
						input2 = schemel + connection_semi[r_semi] + connection_slash[r_slash] + connection_semi[r_slash] + return_random_symbol_string() + end[r_end] + connection_slash[r_slash] + return_random_symbol_string();
					
					System.out.println(input2);
					
					urlDefault.isValid(input); //test each validators with different flags
					System.out.println("Passed default");
					urlSchemeAll.isValid(input2);
					System.out.println("Passed all schemes flag");
					urlSchemeSlash.isValid(input2);
					System.out.println("Passed all schemes + 2 slash flag");
					urlSchemeFrag.isValid(input2);
					System.out.println("Passed all schemes + fragment flag");
					urlSchemeLocal.isValid(input2);
					System.out.println("Passed all schemes + local flag");
					urlSchemeAllFlags.isValid(input2);
