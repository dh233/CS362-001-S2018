   ...
   /**
	...
	//			System.out.println(" Seed:"+randomseed );
				Random random = new Random(randomseed);
				 ...
				 int checkDay = ValuesGenerator.getRandomIntBetween(random, -1, 25);
				 int checkMonth = ValuesGenerator.getRandomIntBetween(random, -1, 13);
				 int checkYear = ValuesGenerator.getRandomIntBetween(random, -1, 1);
		         ...
		         Appt appt = new Appt(startHour,
		                 ...
		                 emailAddress);
				appt.setValid();
				boolean isOnCheck = false;
				if(checkDay == startDay && checkMonth == startMonth && checkYear == startYear){
					isOnCheck = true;
				}
				assertEquals(isOnCheck,appt.isOn(checkDay, checkMonth, checkYear));
